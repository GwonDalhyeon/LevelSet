...
int main()
{
	...
	class level_set initial_level_set(side_xlength, side_ylength, num_xmesh, num_ymesh);
	class level_set sign_distance_level_set(side_xlength, side_ylength, num_xmesh,num_ymesh);
	...
	//TVD_RK_with_error(initial_level_set,t_total,dt, sign_distance_level_set);
	//FE_with_error(initial_level_set,t_total,dt, sign_distance_level_set);
	//GS_with_error(initial_level_set,t_total,dt, sign_distance_level_set);
}